...
d=[F P C D HD]
for i=1:1:5
disp(['Amount of F: ', num2str(d(i))])% fix later
disp(['Amount of P: ', num2str(d(i))])
disp(['Amount of C: ', num2str(d(3))])
disp(['Amount of D: ', num2str(d(4))])
disp(['Amount of HD: ', num2str(d(5))])
end
